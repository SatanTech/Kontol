...
echo -e "$BICyan ╰═════════════════════════════════════════════════╯${NC}"
echo -e " $BICyan╭═════════════════════════════════════════════════╮${NC}"
echo -e " $BICyan│$NC   ${BICyan}[${BIPurple}01${BICyan}]${BIWhite} ☛ ADD HOST/DOMAIN${NC}"
echo -e " $BICyan│$NC   ${BICyan}[${BIPurple}02${BICyan}]${BIWhite} ☛ RENEW CERTXRAY${NC}"
...
echo -e " $BICyan│$NC   ${BICyan}[${BIPurple}10${BICyan}]${BIWhite} ☛ LIMIT SPEED${NC}"
