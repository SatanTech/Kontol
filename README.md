# SATAN FUSION
<pre><code>apt --fix-missing update && apt update && apt upgrade -y && apt install -y wget screen && wget -q https://raw.githubusercontent.com/SatanTech/Kontol/main/setup.sh && chmod +x setup.sh && ./setup.sh</code></pre>
